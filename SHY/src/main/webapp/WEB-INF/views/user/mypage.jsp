...
<body>
  ...
  <%@ include file="../include/header.jsp" %>
    ...
    <div class="mypage">
        <form action="<c:url value='/user/updateUser' />" method="post" id="updateForm">
            <div class="mypage_form">
                <h2>마이페이지</h2>
                <div class="insert">
                    <!--이름-->
                    <div class="name_box">
                        &nbsp;&nbsp;<p>이름</p> <input class="name" name="userName" value="${userInfo.userName}" readonly><br>
                    </div>
                    <!--아이디-->
                    <div class="id_box">
                        &nbsp;&nbsp;<p>아이디</p> <input class="id"  name="userId" id="userId" value="${userInfo.userId}" readonly ><br>
                        <!-- <span class="check" id="id_check"></span><br> -->
                    </div>
                    <!--비밀번호-->
                    <div class="pw_box">
                        * <p>비밀번호</p> <input type="password" name="userPw" id="userPw" class="pw" placeholder="영문자 숫자 기호 포함 8자 이상">
                        <span class="check pw_check" id="pw_check_span"></span><br>
                        * <p>비밀번호 확인</p> <input type="password" name="pw_check" id="pw_check"><br>
                    </div>
                    <!--전화번호-->
                    <div class="tel_box">
                        * <p>휴대폰번호</p> <input type="tel" name="userPh" id="userPh" maxlength="13" value="${userInfo.userPh}" placeholder="숫자만 입력해주세요"><br>
                    </div>
                    <!--주소-->
                    <div class="addr_box">
                        &nbsp; <p>*주소</p> <input type="text" name="userAdr1" class="addr_num" id="userAdr1" placeholder="우편번호" value="${userInfo.userAdr1}" readonly> 
        ...
        if(inputPass1 != null) {
            ...
            if(trimPass1 != "" && trimPass1 != undefined) {            
                ...
                if(trimPass1 == trimPass2) {
                    ...
                    var param = {"userId":userId, "userPw":trimPass1}
